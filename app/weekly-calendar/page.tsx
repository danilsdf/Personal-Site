export default function WeeklyCalendarPage() {
  return (
    <div className="mx-auto max-w-5xl px-4 pb-20 pt-10 text-neutral-900 dark:text-neutral-100 bg-neutral-100 dark:bg-neutral-900">
      {/* TITLE + INTRO */}
      ...
      <section className="mt-10 text-sm">
        <h2 className="mb-3 text-xs font-semibold uppercase tracking-wide text-yellow-600 dark:text-yellow-400">
          Weekly Training Table
        </h2>

        <div className="overflow-x-auto rounded-xl border border-neutral-300 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-900">
          <table className="min-w-full border-collapse text-xs sm:text-sm">
            <thead className="border-b border-neutral-300 dark:border-neutral-700 bg-neutral-200 dark:bg-neutral-800 text-left">
              <tr>
                <th className="px-4 py-2 font-medium text-yellow-600 dark:text-yellow-400">Day</th>
                <th className="px-4 py-2 font-medium text-yellow-600 dark:text-yellow-400">
                  Morning
                </th>
                <th className="px-4 py-2 font-medium text-yellow-600 dark:text-yellow-400">
                  Evening
        ...
        <p className="mt-3 text-xs text-neutral-500 dark:text-neutral-400 max-w-xl">
      ...
      <section className="mt-16 text-center">
        ...
        <button className="mt-5 rounded-full bg-yellow-600 dark:bg-yellow-400 px-6 py-2 text-xs font-semibold text-white dark:text-black shadow-sm transition hover:bg-yellow-700 dark:hover:bg-yellow-300">
          Download Week
        </button>
      </section>
    </div>
